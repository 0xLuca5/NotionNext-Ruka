...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '30152c4ca1ae8131ab49ece8ae453e92,en:7c1d570661754c8fbc568e00a01fd70e',
  THEME: process.env.NEXT_PUBLIC_THEME || 'ruka', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
